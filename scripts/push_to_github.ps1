...
#
# 前提:
#   - Git for Windows（PATH または既定パス）
#   - winget install GitHub.cli
#   - 初回のみ: gh auth login（ブラウザで GitHub にログイン）
#
# 使い方（プロジェクトルートから）:
#   .\scripts\push_to_github.ps1
#   .\scripts\push_to_github.ps1 -RepoName my-basketball-sim
#
# 既に origin がある場合は create をスキップし、git push -u origin main のみ行います。
