...
| 暫定 | **未確認**。 |
| 未実装 | `PRODUCT` は GUI からの同一ガード通過を **残** と記載。編成まわりの **その他 GUI 完結**は **未**（例: 本格 FA 市場。FA 手動は **1 名まで**人事 GUI のみ）。 |
| 未確認 | 全 GUI 経路でのロック整合。 |
...
- 2026-04-07: §5.7 人事を、1対1 GUI・multi（人事/CLI）・FA 手動（1人GUI）・オフ再契約 GUI と整合（`GUI_MAIN_FLOW_AUDIT.md` と同旨）。
