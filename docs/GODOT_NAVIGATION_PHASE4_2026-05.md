...
- **日程閲覧**: **Theme 第1段**（`440c3f6`）＋**第2段・前半**（`986c4ab`）＋**第2段・後半（最小）**（`7fecb99`）＋**追加最小 advance_hint**（`a62b3a7`・**なし/あり表示確認済み**）。**導線は HeaderNavRow + CardNavMenu から到達**（§2.8〜2.8d）。**LeftRail からは遷移しない**。
