...
- **別タスク（未着手）**: **ScrollContent 全体**整理、試合リスト全体の行レイアウト整理、試合リスト行の余白・区切り・カード化、日程 Scroll 全体の本格整備。
