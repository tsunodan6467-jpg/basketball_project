...
- **別タスク（未着手）**: **MissionsBody の Panel 化**、ミッション行カード化、余白・行レイアウト本格調整、**Body系本格整備の中規模整理**、**ロスター本格整備**、**日程 ScrollContent / 試合リスト本格整備**、**ゲーム体験に近い機能 / 画面検討**（**契約 RiskRows margin は `420f240` で対応**）。
